...
public class Portfolio {
    ...
    /**
     * Adiciona uma transação ao portfolio e atualiza a posição correspondente.
     * 
     * <p>
     * Este método coordena duas operações importantes:
     * </p>
     * <ol>
     * <li>Adiciona a transação ao histórico (auditoria)</li>
     * <li>Atualiza ou cria a posição do ativo (estado atual)</li>
     * </ol>
     * 
     * <p>
     * <b>Exemplo:</b>
     ...
     * portfolio.adicionarTransacao(compra);
     * // Histórico atualizado E posição do ativo atualizada
     * }</pre>
     * 
     * @param transacao Transação a ser Adicionada (não pode ser null)
     * @throws IllegalArgumentException se transacao for null
     * @see #atualizarPosicao(Transacao)
     * @see Posicao#atualizarComTransacao(BigDecimal, BigDecimal, boolean)
     */
     ...
     * 
     * <p>
     * Se a posição do ativo já existe, atualiza seus valores.
     * Caso contrário, cria uma nova posição.
     * </p>
     * 
     * <p>
     * <b>Comportamento:</b>
     * </p>
     * <ul>
     * <li><b>Compra:</b> Aumenta quantidade, recalcula preço médio</li>
     * <li><b>Venda:</b> Diminui quantidade proporcionalmente</li>
     * </ul>
     * 
     * @param transacao Transação que originou a atualização
     * @see Posicao#atualizarComTransacao(BigDecimal, BigDecimal, boolean)
     * @see #encontrarPosicao(AtivoFinanceiro)
     */
    ...
    /**
     * Recalcula todos os saldos consolidados do portfolio.
     * 
     * <p>
     * Atualiza os seguintes campos:
     * </p>
     * <ul>
     * <li><b>saldoAtual:</b> Soma de todas as posições ativas</li>
     * <li><b>valorInvestido:</b> Total investido (compras - vendas)</li>
     * <li><b>lucroNaoRealizado:</b> Diferença entre valor atual e investido</li>
     * </ul>
     * 
     * <p>
     * <b>⚠️ Importante:</b> Este método deve ser chamado após qualquer
     * transação que afete os valores do portfolio.
     * </p>
     * 
     * @see #atualizarPercentuais()
     */
