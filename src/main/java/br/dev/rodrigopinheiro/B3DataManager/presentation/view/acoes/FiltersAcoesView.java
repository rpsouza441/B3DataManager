...
/**
 * Componente de filtros para a tela de Ações.
 ...
 */
@Slf4j
public class FiltersAcoesView extends Div {
     ...
     */
    public FiltersAcoesView(Runnable onSearch) {
        setWidthFull();
        ...
        resetBtn.addClickListener(e -> {
            log.debug("Resetando filtros Ações");
            nome.clear();
            startDate.clear();
            endDate.clear();
            precoMedioMin.clear();
        ...
        searchBtn.addClickListener(e -> {
            log.debug("Executando busca Ações com filtros: Nome={}, DataInicial={}, DataFinal={}, PreçoMínimo={}, PreçoMáximo={}",
                    nome.getValue(), startDate.getValue(), endDate.getValue(),
                    precoMedioMin.getValue(), precoMedioMax.getValue());
            onSearch.run();
        });
